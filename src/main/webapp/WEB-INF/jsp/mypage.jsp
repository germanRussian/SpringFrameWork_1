...
<body class="page02">
	...
	<div class="b02 pd16">
		<a href="Bus" class="mb16 qrbtn"> <img
			src="/resources/img/img01.png">QR 승하차 체크하기<img
			src="/resources/img/ico_arrow.png" class="fR">
		</a>
		<div class="mb16">
			<img src="/resources/img/img02.png">잔여 이용 횟수 <span class="fR"><b>${coupon}<%-- <%=coupon %> --%></b>회</span>
		</div>
	...
	<div class="FAB">
		<ul class="ulFl">
			<li class="on">
			<a href="MyPage"><img
					src="/resources/img/ico01_on.png">
				<p>내정보</p></a></li>
				
			<li><a href="Bus"><img src="/resources/img/ico02.png">
				<p>버스탑승</p></a></li>
				
			<li><a href="List"><img src="/resources/img/ico03.png">
				<p>이용내역</p></a></li>
		</ul>
	</div>
</body>
